...
if __name__ == '__main__':
    ...
    model = DecisionForestClassifier(n_estimators=100, criterion='gini', feature_selection='all', feature_prob=[0.25, 0.25, 0.25, 0.25])
    model_r = DecisionForestClassifier(n_estimators=100, criterion='gini', feature_selection='rand', feature_prob=[0.25, 0.25, 0.25, 0.25])
    model_p = ProactiveForestClassifier(n_estimators=100, criterion='gini', feature_selection='prob', feature_prob=[0.25, 0.25, 0.25, 0.25])
